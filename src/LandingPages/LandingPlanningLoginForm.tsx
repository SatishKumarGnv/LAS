  ...
  return (
    <div className="login-card-main">
      <div className="login-card">
        ...
        <h2 className="login-heading">Envisioning and Scenario Planning</h2>
...
const LandingLoginPlanningForm = (props: ILoginFormProps & ILoginState) => (
  <Formik
...
export default LandingLoginPlanningForm;
